...
% RTL-SDR Parameters
sdr_fs = 1e6; % Sampling rate (adjust based on your LoRa signal)
...
% Low-pass Filter (to filter out-of-band noise)
lpf = designfilt('lowpassfir', 'PassbandFrequency', BW / 2, ...
                 'StopbandFrequency', BW, ...
                 'SampleRate', Fs);
